...
class PiperSDKInterface:
    ...
    def get_status(self) -> dict[str, Any]:
        ...
        obs_dict = {
            "shoulder_pan.pos": joint_state.joint_1,
            "shoulder_lift.pos": joint_state.joint_2,
            "elbow_flex.pos": joint_state.joint_3,
            "wrist_flex.pos": joint_state.joint_5,
            "wrist_roll.pos": joint_state.joint_6,
